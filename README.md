...
| Windows | WinUI 3 + .NET 8 | Implemented | [Thumbnail Grid Studio macOS](https://github.com/leiweibau/ThumbnailGridStudio/releases/download/v1.3.1/ThumbnailGridStudio-win-x64-fdd.zip) | [README](./apps/windows/README.md) |
